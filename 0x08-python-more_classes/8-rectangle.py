...
class Rectangle:
    ...
    def __str__(self):
        ...
        Returns:
            str: A string with the rectangle represented by print_symbol.
        """
        if self.__width == 0 or self.__height == 0:
            return ""
    ...
    def __repr__(self):
        ...
        Returns:
            ...
            that can recreate the object using eval().
        """
    ...
    def bigger_or_equal(rect_1, rect_2):
        ...
        Returns:
            ...
            the greater area or rect_1 if they have the same area.
        """
